...
import com.example.mychatapp2.Adapters.MessageAdapter;
import com.example.mychatapp2.Model.Chats;
import com.example.mychatapp2.Model.Users;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myid = firebaseUser.getUid(); //id của người log vào

        friendid = getIntent().getStringExtra("friendid"); // hiển thị id của friend khi item được clicked

        firebaseUser = FirebaseAuth.getInstance().getCurrentUser();

        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("User").child(friendid);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                usernameonToolbar.setText(users.getUsername()); //đặt văn bản của người dùng trên thanh công cụ văn bản
    ...
    private void Status (String status) {
        final DatabaseReference reference =  FirebaseDatabase.getInstance().getReference("User").child(firebaseUser.getUid());
                HashMap<String, Object> hashMap = new HashMap<>();
